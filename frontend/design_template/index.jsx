...
{/* <div className="flex flex-row h-screen">
	<div className="flex flex-col w-full mt-20 mb-8 ml-20 max-w-2xl bg-[#212121] shadow-xl rounded-lg">
		<div className="flex flex-col p-6 overflow-y-scroll scrollbar">
			<div className="flex w-full mt-2 space-x-3 max-w-xs">
				<div className="flex-shrink-0 h-12 w-12 rounded-full overflow-hidden bg-gray-300">
                    <img src={item.alt_img_path} alt="hello" />
                </div>
                
				<div>
					<div className="bg-[#FF6FCF] text-white p-3 rounded-r-lg rounded-bl-lg">
        ...
        <form>
            ...
            <div className="flex items-center px-3 py-2 rounded-md bg-[#303030]">
                <button type="button" className="inline-flex justify-center p-2 rounded-lg cursor-pointer text-gray-400 hover:text-white hover:bg-gray-600">
                ...
                <textarea id="chat" rows="1" wrap="soft" className="block resize-none rounded-md mx-4 p-2.5 w-full text-sm bg-[#121212] border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Your message..."></textarea>
                    <button type="submit" className="inline-flex justify-center p-2 text-[#FF6FCF] rounded-full cursor-pointer hover:text-white hover:bg-[#FF6FCF]">
