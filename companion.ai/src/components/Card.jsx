  ...
  return (
    <div className="w-full bg-[#212121] rounded-xl shadow-lg relative">
        <figure className="relative max-w-sm group">
            <a href="#">
            <img className="w-full h-78 mm:h-64 sm:h-128 object-cover rounded-lg shadow-lg transition-all cursor-pointer filter bg-opacity-30 brightness-[50%] duration-500 group-hover:filter-none" src={item.img_path} alt=""></img>
            </a>
